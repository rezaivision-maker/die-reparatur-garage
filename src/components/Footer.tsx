      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20 text-sm">
          ...
          <div className="space-y-6">
            <div className="flex flex-col">
              <h3 className="text-2xl font-black italic tracking-tighter leading-none text-white">DIE REPARATUR GARAGE</h3>
          ...
          <div>
            ...
            <ul className="space-y-3 font-bold uppercase tracking-wider text-[11px]">
              ...
              <li><Link to="/leistungen" className="hover:text-white transition-colors">Leistungen & Service</Link></li>
              <li><Link to="/ueber-uns" className="hover:text-white transition-colors">Die Werkstatt (Über Uns)</Link></li>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-xs font-black uppercase text-brand-accent tracking-[0.2em] mb-6">Werkstatt</h4>
          ...
          {/* Open Hours */}
          <div>
            <h4 className="text-xs font-black uppercase text-brand-accent tracking-[0.2em] mb-6">Öffnungszeiten</h4>
            <ul className="space-y-3">
              ...
              <li className="flex justify-between border-b border-zinc-800 pb-2">
                <span>Samstag</span>
                <span className="text-brand-accent">Nach Absprache</span>
              </li>
        ...
        <div className="pt-8 border-t border-zinc-800 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500">
            © {new Date().getFullYear()} Die Reparatur Garage • Meisterbetrieb KFZ
          </p>
