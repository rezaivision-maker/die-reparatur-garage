    ...
    <>
      ...
      <div className="bg-brand-gray min-h-screen py-24">
        <div className="max-w-3xl mx-auto px-6 bg-white p-10 lg:p-16 rounded-3xl shadow-sm border border-zinc-200">
          <h1 className="text-4xl font-bold text-brand-dark mb-10">Datenschutzerklärung</h1>
          
          <div className="space-y-8 text-zinc-700 leading-relaxed">
            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">Einleitung und Überblick</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">Verantwortliche Stelle</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">Anwendungsbereich</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">Rechte laut Datenschutz-Grundverordnung</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">Kommunikation (Telefon, E-Mail, Online-Formulare)</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">Webhosting & Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">Google Maps</h2>
              <p>
