    ...
    <>
      ...
      <div className="bg-brand-gray min-h-screen py-24">
        <div className="max-w-3xl mx-auto px-6 bg-white p-10 lg:p-16 rounded-3xl shadow-sm border border-zinc-200">
          <h1 className="text-5xl lg:text-7xl font-normal text-brand-dark mb-10 font-heading uppercase leading-[1]">Impressum</h1>
          
          <div className="space-y-8 text-zinc-700 leading-relaxed">
            <section>
              <h2 className="text-xl font-normal text-brand-dark mb-4 font-display">Informationspflicht laut § 5 TMG</h2>
            ...
            <section>
              <h2 className="text-xl font-normal text-brand-dark mb-4 font-display">Kontakt</h2>
            ...
            <section>
              <h2 className="text-xl font-normal text-brand-dark mb-4 font-display">Zusätzliche Informationen</h2>
              <p>UID-Nummer: DE1913132521</p>
              <p>Berufsbezeichnung: KFZ-Meister</p>
            </section>

            <section>
              <h2 className="text-xl font-normal text-brand-dark mb-4 font-display">EU-Streitschlichtung</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-normal text-brand-dark mb-4 font-display">Haftung für Inhalte dieser Website</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-normal text-brand-dark mb-4 font-display">Haftung für Links auf dieser Website</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-normal text-brand-dark mb-4 font-display">Urheberrechtshinweis</h2>
              <p>
